...
function goOverValues() {
  if (checkName(document.getElementById("fLname").value) == true
    && checkEmail(document.getElementById("emailCheck").value) == true
    && checkPhoneNumber(document.getElementById("phoneNumberCheck").value) == true

    && yesOrNoCheck("visit") == true
    && yesOrNoCheck("location") == true && otherCheck("visit", document.getElementById("otherInputVisit").value) &&
...
function checkEverything() {
  ...
  if (checkPhoneNumber(document.getElementById("phoneNumberCheck").value) == false) {
  ...
  if (yesOrNoCheck("visit") == false || otherCheck("visit", document.getElementById("otherInputVisit").value) == false) {
  ...
  if (yesOrNoCheck("location") == false || otherCheck("location", document.getElementById("otherInputLocation").value) == false) {
